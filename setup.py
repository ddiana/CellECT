...
setup(name='CellECT',\
    ...
    package_data = {'CellECT': ['utils/*.m', 'utils/*.py', 'utils/*mex*', 'utils/*txt', 'utils/fast_marching/*', 'README.TXT','track_tool/resources/gui_thumbnails/*', 'resources/*',  'data/training/ascidian/*', 'data/training/purdue/*']},\
	classifiers = [\
