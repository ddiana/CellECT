...
#
# Created: Fri Sep 20 17:32:32 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radioButton_random.setGeometry(QtCore.QRect(10, 50, 251, 21))
        self.radioButton_random.setObjectName("radioButton_random")
        self.radioButton_no_nuclei = QtGui.QRadioButton(self.groupBox)
        self.radioButton_no_nuclei.setGeometry(QtCore.QRect(10, 20, 261, 22))
        self.radioButton_no_nuclei.setChecked(True)
